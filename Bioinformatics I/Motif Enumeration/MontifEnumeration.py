...
if __name__ == '__main__':
	if len(sys.argv) == 2:
		...
		dnas = ['TAAGGTAATTCCTTCCTTCAGAAAG', 'CTGAGGTACAACTGAATGTAGACAG', 'TATAGTAGAATATCTATAGGTGGGA', 'CAGAGAGTATCCAAGACTCTTCAAC', 'TCCGAATCCCGATAATAGAGGCGGT', 'GCCGTTTCGTCTAAGTTGCCTAGAG']
		k = 5
		d = 2
